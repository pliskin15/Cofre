...
def _extrair_loja(historico: str) -> str | None:
    """Retorna '01', '12', etc., ou None se não bater o padrão."""
...
class BrinksCreditos(ttk.Frame):
    ...
    def _carregar_do_banco(self):
        self._resumo = db.get_creditos_brinks()
    ...
    def _importar(self):
        path = filedialog.askopenfilename(
            title="Selecionar Razão Modelo I — Brinks Créditos",
        ...
        try:
            # A planilha tem cabeçalho nas primeiras linhas de metadata;
            # a linha 4 (índice 3) contém os nomes das colunas reais.
            ...
            # Filtra apenas as linhas de depósito de loja
            ...
            inseridos, ignorados = db.insert_creditos_brinks(registros)
